                  ...
                  <div className="grid grid-cols-2 gap-4">
                    ...
                    <div>
                      ...
                      <select value={formData.source} onChange={(e) => setFormData({ ...formData, source: e.target.value })} className="w-full px-3 py-2 bg-background border border-border rounded-md text-foreground focus:border-primary outline-none">
                        ...
                        <option value="libretexts">LibreTexts</option>
                        ...
                        <option value="saylor">Saylor Academy</option>
                        <option value="oer_commons">OER Commons</option>
                        <option value="mit_ocw">MIT OpenCourseWare</option>
                        <option value="ck12">CK-12</option>
                        <option value="openlearn">OpenLearn</option>
                        <option value="ajol">AJOL</option>
                        <option value="kicd">KICD</option>
                        <option value="knec">KNEC</option>
                        <option value="easy_elimu">Easy Elimu</option>
                        <option value="atika_school">Atika School</option>
                        <option value="kenyaplex">KenyaPlex</option>
                        <option value="schools_net">Schools Net Kenya</option>
                        <option value="cbc_resources">CBC Resources</option>
                        <option value="teachers_updates">Teachers Updates</option>
