...
import { Loader2, Grid3x3, List, BookOpen, ChevronLeft, ChevronRight, Filter, Search as SearchIcon } from "lucide-react";
...
export default function Catalog() {
  ...
  // between different /catalog?... URLs.
  ...
  // Keep state in sync when navigating to a different /catalog?... URL
  ...
  // Sync URL with filter state (deep-linkable filters)
  useEffect(() => {
    ...
    navigate(`/catalog?${qs.toString()}`, { replace: true });
    // eslint-disable-next-line react-hooks/exhaustive-deps
  }, [selectedGenre, selectedLanguage, selectedLevel, selectedSource, localSearch, sortBy]);

  const pageSize = 20;
  const offset = currentPage * pageSize;

  // Fetch books with all filters (server-side ILIKE for search, exact for others)
        ...
        <div className="mb-8">
          <div className="flex items-center gap-4 mb-4">
            <div className="accent-line-left">
              <h1 className="text-4xl font-bold neon-glow">E-MATERIALS CATALOG</h1>
            </div>
          </div>
          <p className="text-muted-foreground text-lg">Browse free ebooks, past papers and curriculum materials</p>
        </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
            ...
            <div>
              ...
              >
                ...
                <option value="primary">Primary (PP1 - Grade 6)</option>
                <option value="middle_school">Middle School (Grade 7 - 9)</option>
                <option value="high_school">High School (Form 1 - 4)</option>
